...
describe('ProgressBar', () => {
  ...
  it('renders with different progress values', async () => {
    ...
    const { getByRole: getProgressBar2, update: update2 } = render(<ProgressBar progress={50} />);
    ...
    const { getByRole: getProgressBar3, update: update3 } = render(<ProgressBar progress={100} />);
